...
import com.mvp.testmvp.log.LogUtilHelper;
...
public final class HttpLoggingInterceptorM implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Utils.Companion.getInstance().writerLog(requestStartMessage);
            ...
            if (!logBody || !hasRequestBody) {
                ...
                if (isPlaintext(buffer)) {
                    ...
                    logger.log("--> END " + request.method() + " (" + requestBody.contentLength() + "-byte body)",
                            LogUtil.D);
                    Utils.Companion.getInstance().writerLog(str);
        ...
        Utils.Companion.getInstance().writerLog("<-- " + response.code() + ' ' + response.message() + ' ' + response.request()
